    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersistedEvent", x => x.Version);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserApiKeyId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserApiKeys", x => x.UserApiKeyId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublishedPersistedEvent", x => x.Version);
                    table.ForeignKey(
                        name: "FK_PublishedPersistedEvent_PersistedEvent_Version",
                        column: x => x.Version,
                        principalSchema: "EventJournal",
                        principalTable: "PersistedEvent",
